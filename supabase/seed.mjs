...
async function main() {
  ...
  // 음식 사진 — TheMealDB / TheCocktailDB 의 실제 요리·음료 사진(안정 CDN, 무료).
  const menuDefs = [
    // 체크인 스페셜
    { category: "체크인 스페셜", name: "체크인 스테이크", price: 24000, description: "오늘 밤 가장 먼저 권해드리는 객실 정찬", sort_order: 1, image_url: "https://www.themealdb.com/images/media/meals/vussxq1511882648.jpg" },
    // 객실 정찬
    { category: "객실 정찬", name: "붉은 커튼 토마토 파스타", price: 16000, description: "복도 끝 붉은 커튼 뒤에서 시작된 시그니처 메뉴", sort_order: 1, image_url: "https://www.themealdb.com/images/media/meals/ustsqw1468250014.jpg" },
    { category: "객실 정찬", name: "월광 크림 리조또", price: 17000, description: "조용한 밤에 가장 잘 어울리는 부드러운 한 접시", sort_order: 2, image_url: "https://www.themealdb.com/images/media/meals/xxrxux1503070723.jpg" },
    { category: "객실 정찬", name: "검은 복도의 오징어먹물 리조또", price: 18000, description: "호텔의 가장 어두운 복도에서 영감을 받은 시그니처", sort_order: 3, image_url: "https://www.themealdb.com/images/media/meals/wqqvyq1511179730.jpg" },
